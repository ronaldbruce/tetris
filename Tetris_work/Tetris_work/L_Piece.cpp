...
void LPiece::spawnPiece(GameBoard &gameArray)
{
...
void LPiece::resetPiece(char color)
{
	*this = LPiece(color);
}
...
void LPiece::move(GameBoard &gameArray, int direction, bool &placed, int stage)
{
	if (stage == 1)
	{
		switch (direction) {
...
void LPiece::rotate(GameBoard &gameArray, int stage, bool &placed)
{
	if (stage == 1)
	{
		if (!isCollision(gameArray, DOWN, placed))
		{
			if (!isCollision(gameArray, LEFT, placed))
			{
				if (!isCollision(gameArray, RIGHT, placed))
				{
					if (!(block1.cordX + 1 >= 9) && !(block2.cordX + 1 >= 9) && !(block3.cordX + 1 >= 9) && !(block4.cordX + 1 >= 9))
					{
						//block 3
						gameArray.gameArray[block3.cordX][block3.cordY].active = false; //sets previous location to non active
						gameArray.gameArray[block3.cordX][block3.cordY].color = 'x'; //sets previous location to background
						...
						gameArray.gameArray[block4.cordX][block4.cordY].active = false; //sets previous location to non active
						gameArray.gameArray[block4.cordX][block4.cordY].color = 'x'; //sets previous location to background
						gameArray.gameArray[block4.cordX - 1][block4.cordY - 2] = block4; //sets next location equal to block4
						block4.cordX -= 1;
						block4.cordY -= 2;
			...
			if (!isCollision(gameArray, LEFT, placed))
			{
				if (!isCollision(gameArray, RIGHT, placed))
				{
					if (!(block1.cordX + 1 >= 9) && !(block2.cordX + 1 >= 9) && !(block3.cordX + 1 >= 9) && !(block4.cordX + 1 >= 9))
					{
						...
						gameArray.gameArray[block1.cordX][block1.cordY].active = false; //sets previous location to non active
						gameArray.gameArray[block1.cordX][block1.cordY].color = 'x'; //sets previous location to background
						gameArray.gameArray[block1.cordX + 2][block1.cordY - 1] = block1; //sets next location equal to block1
						block1.cordX += 2;
						block1.cordY -= 1;
			...
			if (!isCollision(gameArray, LEFT, placed))
			{
				if (!isCollision(gameArray, RIGHT, placed))
				{
					if (!(block1.cordX + 1 >= 9) && !(block2.cordX + 1 >= 9) && !(block3.cordX + 1 >= 9) && !(block4.cordX + 1 >= 9))
					{
						...
						gameArray.gameArray[block4.cordX][block4.cordY].active = false; //sets previous location to non active
						gameArray.gameArray[block4.cordX][block4.cordY].color = 'x'; //sets previous location to background
						gameArray.gameArray[block4.cordX][block4.cordY + 2] = block4; //sets next location equal to block4
						block4.cordY += 2;
			...
			if (!isCollision(gameArray, LEFT, placed))
			{
				if (!isCollision(gameArray, RIGHT, placed))
				{
					if (!(block1.cordX + 1 >= 9) && !(block2.cordX + 1 >= 9) && !(block3.cordX + 1 >= 9) && !(block4.cordX + 1 >= 9))
					{
						...
						gameArray.gameArray[block4.cordX][block4.cordY].active = false; //sets previous location to non active
						gameArray.gameArray[block4.cordX][block4.cordY].color = 'x'; //sets previous location to background
						gameArray.gameArray[block4.cordX + 2][block4.cordY] = block4; //sets next location equal to block4
						block4.cordX += 2;
