...
void TPiece::spawnPiece(GameBoard &gameArray)
{
...
void TPiece::resetPiece(char color)
{
	*this = TPiece(color);
}
...
void TPiece::move(GameBoard &gameArray, int direction, bool &placed, int stage)
{
	if (stage == 1)
	{
...
void TPiece::rotate(GameBoard &gameArray, int stage, bool &placed)
{
	if (stage == 1)
	{
		...
		gameArray.gameArray[block2.cordX][block2.cordY].active = false; //sets previous location to non active
		gameArray.gameArray[block2.cordX][block2.cordY].color = 'x'; //sets previous location to background
		gameArray.gameArray[block2.cordX + 2][block2.cordY] = block2; //sets next location equal to block3
		block2.cordX += 2;
	...
	else if (stage == 2)
	{
		if (!isCollision(gameArray, DOWN, placed))
		{
			...
			gameArray.gameArray[block3.cordX][block3.cordY].active = false; //sets previous location to non active
			gameArray.gameArray[block3.cordX][block3.cordY].color = 'x'; //sets previous location to background
			gameArray.gameArray[block3.cordX + 2][block3.cordY] = block3; //sets next location equal to block3
			block3.cordX += 2;
		}
	}
