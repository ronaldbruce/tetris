...
void JPiece::spawnPiece(GameBoard &gameArray)
{
...
void JPiece::resetPiece(char color)
{
	*this = JPiece(color);
}
...
void JPiece::move(GameBoard &gameArray, int direction, bool &placed, int stage)
{
	if (stage == 1)
	{
		switch (direction) {
...
void JPiece::rotate(GameBoard &gameArray, int stage, bool &placed)
{
	if (stage == 1)
	{
		//block 1
		...
		gameArray.gameArray[block2.cordX][block2.cordY].active = false; //sets previous location to non active
		gameArray.gameArray[block2.cordX][block2.cordY].color = 'x'; //sets previous location to background
		gameArray.gameArray[block2.cordX][block2.cordY] = block2; //sets next location equal to block3

		//block 3
		gameArray.gameArray[block3.cordX][block3.cordY].active = false; //sets previous location to non active
		gameArray.gameArray[block3.cordX][block3.cordY].color = 'x'; //sets previous location to background
		gameArray.gameArray[block3.cordX - 1][block3.cordY - 1] = block3; //sets next location equal to block3
		block3.cordX -= 1;
		block3.cordY -= 1;
		...
		gameArray.gameArray[block4.cordX][block4.cordY].active = false; //sets previous location to non active
		gameArray.gameArray[block4.cordX][block4.cordY].color = 'x'; //sets previous location to background
		gameArray.gameArray[block4.cordX - 2][block4.cordY - 2] = block4; //sets next location equal to block4
		block4.cordX -= 2;
		block4.cordY -= 2;
	...
	else if (stage == 2)
	{
		if (!isCollision(gameArray, DOWN, placed))
		{
			...
			gameArray.gameArray[block1.cordX][block1.cordY].active = false; //sets previous location to non active
			gameArray.gameArray[block1.cordX][block1.cordY].color = 'x'; //sets previous location to background
			gameArray.gameArray[block1.cordX + 1][block1.cordY - 2] = block1; //sets next location equal to block1
			block1.cordX += 1;
			block1.cordY -= 2;
			...
			gameArray.gameArray[block2.cordX][block2.cordY].active = false; //sets previous location to non active
			gameArray.gameArray[block2.cordX][block2.cordY].color = 'x'; //sets previous location to background
			gameArray.gameArray[block2.cordX][block2.cordY - 1] = block2; //sets next location equal to block3
			block2.cordY -= 1;
		}
	}
	...
	else if (stage == 3)
	{
		if (!isCollision(gameArray, DOWN, placed))
		{
			...
			gameArray.gameArray[block3.cordX][block3.cordY].active = false; //sets previous location to non active
			gameArray.gameArray[block3.cordX][block3.cordY].color = 'x'; //sets previous location to background
			gameArray.gameArray[block3.cordX][block3.cordY + 2] = block3; //sets next location equal to block3
			block3.cordY += 2;
			...
			gameArray.gameArray[block1.cordX][block1.cordY].active = false; //sets previous location to non active
			gameArray.gameArray[block1.cordX][block1.cordY].color = 'x'; //sets previous location to background
			gameArray.gameArray[block1.cordX - 2][block1.cordY] = block1; //sets next location equal to block1
			block1.cordX -= 2;

			//block 2
			gameArray.gameArray[block2.cordX][block2.cordY].active = false; //sets previous location to non active
			gameArray.gameArray[block2.cordX][block2.cordY].color = 'x'; //sets previous location to background
			gameArray.gameArray[block2.cordX - 1][block2.cordY + 1] = block2; //sets next location equal to block3
			block2.cordX -= 1;
			block2.cordY += 1;
		}
	}
	...
	else if (stage == 4)
	{
		if (!isCollision(gameArray, DOWN, placed))
		{
			...
			gameArray.gameArray[block2.cordX][block2.cordY].active = false; //sets previous location to non active
			gameArray.gameArray[block2.cordX][block2.cordY].color = 'x'; //sets previous location to background
			gameArray.gameArray[block2.cordX + 1][block2.cordY] = block2; //sets next location equal to block3
			block2.cordX += 1;
			//block 1
			gameArray.gameArray[block1.cordX][block1.cordY].active = false; //sets previous location to non active
			gameArray.gameArray[block1.cordX][block1.cordY].color = 'x'; //sets previous location to background
			...
			gameArray.gameArray[block3.cordX][block3.cordY].active = false; //sets previous location to non active
			gameArray.gameArray[block3.cordX][block3.cordY].color = 'x'; //sets previous location to background
			gameArray.gameArray[block3.cordX + 2][block3.cordY - 1] = block3; //sets next location equal to block3
			block3.cordX += 2;
			block3.cordY -= 1;
