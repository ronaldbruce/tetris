...
void IPiece::spawnPiece(GameBoard &gameArray)
{
...
void IPiece::resetPiece(char color)
{
	*this = IPiece(color);
}
...
void IPiece::move(GameBoard &gameArray, int direction, bool &placed, int stage)
{
	if (stage == 1 || stage == 3)
	{
		switch (direction) {
...
void IPiece::rotate(GameBoard &gameArray, int stage, bool &placed)
{
	if (stage == 1 || stage == 3)
	{
		if (!isCollision(gameArray, DOWN, placed))
		{
			if (!isCollision(gameArray, LEFT, placed))
			{
				if (!isCollision(gameArray, RIGHT, placed))
				{
					...
					gameArray.gameArray[block1.cordX][block1.cordY].active = false; //sets previous location to non active
					gameArray.gameArray[block1.cordX][block1.cordY].color = 'x'; //sets previous location to background
					gameArray.gameArray[block2.cordX][block2.cordY + 1] = block1; //sets next location equal to block1
					block1.cordX += 1;
					block1.cordY += 1;
					...
					gameArray.gameArray[block3.cordX][block3.cordY].active = false; //sets previous location to non active
					gameArray.gameArray[block3.cordX][block3.cordY].color = 'x'; //sets previous location to background
					gameArray.gameArray[block2.cordX][block2.cordY - 1] = block3; //sets next location equal to block3
					block3.cordX -= 1;
					block3.cordY -= 1;
					...
					gameArray.gameArray[block4.cordX][block4.cordY].active = false; //sets previous location to non active
					gameArray.gameArray[block4.cordX][block4.cordY].color = 'x'; //sets previous location to background
					gameArray.gameArray[block2.cordX][block2.cordY - 2] = block4; //sets next location equal to block4
					block4.cordX -= 2;
					block4.cordY -= 2;
				}
			}
	...
	else if (stage == 2 || stage == 4)
	{
		if (!isCollision(gameArray, DOWN, placed))
		{
			...
			gameArray.gameArray[block1.cordX][block1.cordY].active = false; //sets previous location to non active
			gameArray.gameArray[block1.cordX][block1.cordY].color = 'x'; //sets previous location to background
			gameArray.gameArray[block2.cordX - 1][block2.cordY] = block1; //sets next location equal to block1
			block1.cordX -= 1;
			block1.cordY -= 1;
			...
			gameArray.gameArray[block3.cordX][block3.cordY].active = false; //sets previous location to non active
			gameArray.gameArray[block3.cordX][block3.cordY].color = 'x'; //sets previous location to background
			gameArray.gameArray[block2.cordX + 1][block2.cordY] = block3; //sets next location equal to block3
			block3.cordX += 1;
			block3.cordY += 1;
			...
			gameArray.gameArray[block4.cordX][block4.cordY].active = false; //sets previous location to non active
			gameArray.gameArray[block4.cordX][block4.cordY].color = 'x'; //sets previous location to background
			gameArray.gameArray[block2.cordX + 2][block2.cordY] = block4; //sets next location equal to block4
			block4.cordX += 2;
			block4.cordY += 2;
		}
	}
