...
SquarePiece::SquarePiece(char color)
{
	block1.cordX = 4;
	block1.cordY = 16;
	block2.cordX = 5;
...
void SquarePiece::spawnPiece(GameBoard &gameArray)
{
...
void SquarePiece::resetPiece(char color)
{
	*this = SquarePiece(color);
}
...
void SquarePiece::move(GameBoard &gameArray, int direction, bool &placed, int stage)
{
...
void SquarePiece::rotate(GameBoard &gameArray, int stage, bool &placed)
{
